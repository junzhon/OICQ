$(document).ready(function() {
    ...
    }) var owlslide_1 = $('.slider-1') owlslide_1.owlCarousel({
        loop: !1,
        margin: 0,
        nav: !1,
        autoplay: !1,
    ...
    }) $('.start-tour,.next-tour').on('click',
        function() {
            owlslide_1.trigger('next.owl.carousel')
        });
    $('.tour-close-btn').on('click',
        function() {
            $('body').removeClass('blureffect');
